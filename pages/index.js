...
const Banner = ({
	...
	>
		...
		<Box p="5">
			...
			<Text fontSize="s3xl" fontWeight="bold">
				{title1}
				<br />
				{title2}
			</Text>
	...
	return (
		<Box>
			<Banner
				...
				imageUrl="https://images.pexels.com/photos/1642125/pexels-photo-1642125.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260"
			/>
			<Flex flexWrap="wrap">
